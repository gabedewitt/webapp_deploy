...
- [_AGEG5YR see codebook](https://www.cdc.gov/brfss/annual_data/2015/pdf/codebook15_llcp.pdf)""")
	...
	with col2:
		plot_model(model, plot = 'class_report', display_format='streamlit', plot_kwargs = {'percent' : True})		
		plot_model(model, plot = 'boundary', display_format='streamlit', plot_kwargs = {'percent' : True})	
		plot_model(model, plot = 'confusion_matrix', display_format='streamlit', plot_kwargs = {'percent' : True})	
		plot_model(model, plot = 'auc', display_format='streamlit', plot_kwargs = {'percent' : True})				
		plot_model(model, plot = 'feature_all', display_format='streamlit', plot_kwargs = {'percent' : True})
